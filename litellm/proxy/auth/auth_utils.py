...
def get_customer_user_header_from_mapping(user_id_mapping) -> Optional[List[str]]:
    """Return all header names mapped to CUSTOMER role, lowercased (dict-based)."""
...
def get_end_user_id_from_request_body(
    ...
    if request_headers is not None:
        custom_header_name_to_check: Optional[Union[List[str], str]] = None
