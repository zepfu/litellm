...
_normalize_opencode_go_adapter_model_name = _aawm_adapter_model_resolution._normalize_opencode_go_adapter_model_name
...
_resolve_codex_nvidia_completion_adapter_model = _aawm_adapter_model_resolution._resolve_codex_nvidia_completion_adapter_model
...
async def opencode_zen_proxy_route(
    ...
    return await pass_through_request(
        ...
        egress_credential_family=_opencode_zen_constants._OPENCODE_ZEN_CREDENTIAL_FAMILY,
        expected_target_family=_opencode_zen_constants._OPENCODE_ZEN_TARGET_FAMILY,
