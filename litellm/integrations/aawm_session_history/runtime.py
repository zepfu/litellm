...
_AAWM_SESSION_HISTORY_SHUTDOWN_BUDGET_SECONDS = 2.0
...
_aawm_session_history_shutdown_lock = threading.Lock()
_aawm_session_history_shutdown_in_progress = False
_aawm_session_history_shutdown_deadline_monotonic = 0.0
