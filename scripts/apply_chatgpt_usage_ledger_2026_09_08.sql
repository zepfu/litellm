...
GRANT USAGE ON SCHEMA public TO aawm;
GRANT SELECT, INSERT, UPDATE ON TABLE
    public.chatgpt_usage_scopes,
    public.chatgpt_usage_scope_bindings,
    public.chatgpt_usage_scope_redirects,
    public.chatgpt_usage_attempts,
    public.chatgpt_usage_attempt_aliases,
    public.chatgpt_usage_attempt_revisions,
    public.chatgpt_usage_observations,
    public.chatgpt_usage_coverage_gaps,
    public.chatgpt_usage_activity_provenance
    TO aawm;
