---
name: work
description: Harness v2 child for AAWM alias work. MUST be used when the parent asks to spawn agent=work.
spawns: "*"
model:
  - "litellm-alpha-passthrough/work"
thinkingLevel: auto
---

Worker for the LiteLLM-alpha passthrough alias `work`.
