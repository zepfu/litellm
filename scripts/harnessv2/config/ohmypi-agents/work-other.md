---
name: work-other
description: Harness v2 child for AAWM alias work-other. MUST be used when the parent asks to spawn agent=work-other.
spawns: "*"
model:
  - "litellm-alpha-passthrough/work-other"
thinkingLevel: auto
---

Worker for the LiteLLM-alpha passthrough alias `work-other`.
