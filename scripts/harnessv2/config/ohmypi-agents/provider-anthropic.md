...
description: Harness v2 child for AAWM alias provider-anthropic. MUST be used when the parent asks to spawn agent=provider-anthropic.
spawns: "*"
model:
  - "litellm-alpha-passthrough/provider-anthropic"
thinkingLevel: auto
---

Worker for the LiteLLM-alpha passthrough alias `provider-anthropic`.
