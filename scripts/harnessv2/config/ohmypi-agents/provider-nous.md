---
name: provider-nous
description: Harness v2 child for AAWM alias provider-nous. MUST be used when the parent asks to spawn agent=provider-nous.
spawns: "*"
model:
  - "litellm-alpha-passthrough/provider-nous"
thinkingLevel: auto
---

Worker for the LiteLLM-alpha passthrough alias `provider-nous`.
