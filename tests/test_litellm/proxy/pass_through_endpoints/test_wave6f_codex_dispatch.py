    ...
    *,
    ...
    host: dict[str, Any] = {
        **resolvers,
        ...
        "_handle_codex_opencode_go_adapter_route": _fake_adapter_route,
        "_handle_codex_nous_chat_completions_adapter_route": _fake_adapter_route,
...
class TestSupportedDispatch:
    ...
    @pytest.mark.asyncio
    async def test_opencode_go_dispatch(self) -> None:
        host, sentinel = _make_dispatch_host(
            matching_adapter="_resolve_codex_opencode_go_adapter_model",
        )
        codex_dispatch.install(host)
        result = await host["try_dispatch_codex_request"](**_dispatch_kwargs())
        assert result is sentinel
...
class TestDispatchOrdering:
    ...
    async def test_alias_wins_over_opencode_zen(self) -> None:
        ...
        host: dict[str, Any] = {
            ...
            "_handle_codex_opencode_go_adapter_route": _zen_route,
            "_handle_codex_nous_chat_completions_adapter_route": _zen_route,
...
class TestErrorPropagation:
    ...
    async def test_handler_exception_propagates(self) -> None:
        ...
        host: dict[str, Any] = {
            ...
            "_handle_codex_opencode_go_adapter_route": _exploding_route,
            "_handle_codex_nous_chat_completions_adapter_route": _exploding_route,
